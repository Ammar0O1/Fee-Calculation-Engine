...
public class FeeRule {
    ...
    public FeeRule(UUID ruleId, String userId, UserType userType, TransactionType transactionType, Currency sourceCurrency, Currency destinationCurrency, FeeSideDefinition senderFee, FeeSideDefinition receiverFee, LocalDateTime effectiveDate, boolean active, String description){
